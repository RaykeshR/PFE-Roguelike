...
\subsection{Espace d'État $\mathcal{S}$}
...
\subsection{Espace d'Action $\mathcal{A}$}
...
\subsection{Fonction de Récompense $R$ et Reward Shaping}
...
\subsection{Politique d'Exploration $\epsilon$-Greedy}
